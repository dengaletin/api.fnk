...
class DeviceSearch extends Device
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['device_token', 'access_token', 'language', 'nickname', 'login', 'first_name', 'last_name', 'phone', 'email', 'registered_on', 'confirm'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        foreach (['nickname', 'login', 'first_name', 'last_name', 'phone', 'email', 'registered_on'] as $attribute) {
        ...
        $query->andFilterWhere(['like', 'profile.login', $this->login]);
        ...
        $query->andFilterWhere(['like', 'profile.registered_on', $this->registered_on]);
